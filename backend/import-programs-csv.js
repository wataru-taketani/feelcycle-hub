...
var programs_service_1 = require("./src/services/programs-service");
...
function importProgramsFromCSV() {
    return __awaiter(this, void 0, void 0, function () {
        var csvFilePath, csvContent, programs, programsService, importedPrograms, programCodeCounts, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    programs = parseCSV(csvContent);
                    console.log("\uD83D\uDCCA Parsed ".concat(programs.length, " programs from CSV"));
                    // Show sample data
                    console.log('\n📝 Sample programs:');
                    programs.slice(0, 5).forEach(function (program, index) {
                    ...
                    // Save to DynamoDB
                    console.log('\n💾 Saving to DynamoDB...');
                    programsService = new programs_service_1.ProgramsService();
                    return [4 /*yield*/, programsService.storeProgramsData(programs)];
                case 2:
                    _a.sent();
                    console.log("\u2705 Successfully imported ".concat(programs.length, " programs to DynamoDB"));
                    // Verify data
                    console.log('\n🔍 Verifying imported data...');
                    return [4 /*yield*/, programsService.getAllPrograms()];
                case 3:
                    importedPrograms = _a.sent();
                    console.log("\uD83D\uDCCA Found ".concat(importedPrograms.length, " programs in database"));
                    programCodeCounts = importedPrograms.reduce(function (acc, program) {
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('❌ Failed to import programs:', error_1);
                    throw error_1;
...
// Run the import
importProgramsFromCSV().then(function () {
