...
exports.feelcycleScraper = exports.FeelcycleScraper = void 0;
/**
 * FEELCYCLE scraping service
 * 37 studios across Japan support
 */
class FeelcycleScraper {
    /**
     ...
     */
    static async getAvailableDates(studioCode) {
        try {
     ...
     */
    static async searchLessons(studioCode, date, filters) {
        try {
            ...
            if (filters?.program) {
                filteredLessons = filteredLessons.filter(lesson => lesson.program.toLowerCase().includes(filters.program.toLowerCase()));
            }
            if (filters?.instructor) {
                filteredLessons = filteredLessons.filter(lesson => lesson.instructor.toLowerCase().includes(filters.instructor.toLowerCase()));
            }
     ...
     */
    static async checkLessonAvailability(studioCode, date, time, lessonName, instructor) {
        try {
     ...
     */
    static getStudioInfo(studioCode) {
...
exports.FeelcycleScraper = FeelcycleScraper;
exports.feelcycleScraper = new FeelcycleScraper();
