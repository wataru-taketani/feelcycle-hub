...
function checkAvailableStudios() {
    return __awaiter(this, void 0, void 0, function () {
        var studios, testStudio, lessons, lessonsWithColors, lessonError_1, error_1, cleanupError_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    studios = _a.sent();
                    console.log("Found ".concat(studios.length, " studios:"));
                    studios.forEach(function (studio, index) {
                        console.log("".concat(index + 1, ". ").concat(studio.name, " (").concat(studio.code, ")"));
                    });
                    if (!(studios.length > 0)) return [3 /*break*/, 6];
                    testStudio = studios[0];
                    console.log("\n\uD83E\uDDEA Testing color scraping with ".concat(testStudio.name, " (").concat(testStudio.code, ")..."));
                    _a.label = 3;
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, real_scraper_1.RealFeelcycleScraper.searchAllLessons(testStudio.code)];
                case 4:
                    lessons = _a.sent();
                    console.log("Found ".concat(lessons.length, " lessons for ").concat(testStudio.name));
                    ...
                    if (lessonsWithColors.length > 0) {
                        ...
                        lessonsWithColors.slice(0, 3).forEach(function (lesson, index) {
                        ...
                        lessons.slice(0, 3).forEach(function (lesson, index) {
                            console.log("".concat(index + 1, ". ").concat(lesson.lessonName, " (").concat(lesson.program, ")"));
                    ...
                    return [3 /*break*/, 6];
                case 5:
                    lessonError_1 = _a.sent();
                    console.error("\u274C Failed to get lessons for ".concat(testStudio.name, ":"), lessonError_1);
                    return [3 /*break*/, 6];
...
// Run the test
checkAvailableStudios().then(function () {
