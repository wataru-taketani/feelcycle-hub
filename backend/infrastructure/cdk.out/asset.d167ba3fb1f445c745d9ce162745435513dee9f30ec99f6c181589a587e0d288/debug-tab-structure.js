...
async function debugTabStructure() {
    ...
    try {
        ...
        const tabStructureAfterDate = await page.evaluate(() => {
            ...
            tabContainers.forEach((container, containerIndex) => {
                ...
                allChildren.forEach(element => {
                    ...
                    if (text && (text.includes('新宿') || text.includes('渋谷') || text.includes('池袋') ||
        ...
        tabStructureAfterDate.forEach((structure, index) => {
            ...
            structure.studioElements.forEach((element, elementIndex) => {
        ...
        if (domStructure.found) {
            ...
            const printStructure = (element, depth = 0) => {
        ...
        const hasExpectedLesson = currentLessons.first10.some(lesson => lesson.time.includes('07:00') && lesson.name.includes('BB2 NOW 1') && lesson.instructor.includes('Fuka'));
