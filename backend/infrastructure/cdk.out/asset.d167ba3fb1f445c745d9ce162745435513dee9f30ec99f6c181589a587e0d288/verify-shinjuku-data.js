...
async function verifyShinjukuData() {
    ...
    try {
        ...
        const lessons = await lessons_service_1.lessonsService.getLessonsForStudioAndDate('sjk', '2025-07-24');
        ...
        if (lessons.length > 0) {
            ...
            sortedLessons.forEach(lesson => {
                ...
                if (hour >= 7 && hour < 10)
                    timeSlots['朝 (07:00-09:59)']++;
                else if (hour >= 10 && hour < 12)
                    timeSlots['午前 (10:00-11:59)']++;
                else if (hour >= 12 && hour < 15)
                    timeSlots['昼 (12:00-14:59)']++;
                else if (hour >= 15 && hour < 18)
                    timeSlots['午後 (15:00-17:59)']++;
                else if (hour >= 18 && hour <= 22)
                    timeSlots['夜 (18:00-22:15)']++;
            });
            console.log(`\n  ⏰ 時間帯別:`);
